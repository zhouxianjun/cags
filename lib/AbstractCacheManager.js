 ...
 */
let AbstractCacheManager = ring.create({
    mem: null,
    /**
            ...
            if (!self.mem){
                if (!self.localList){
                    self.load(function(list){
                        resolve.call(self, list);
                    });
                    return;
                }
                resolve.call(self, null);
                return;
            }
    ...
    getMap(){
        ...
        return new Promise(function(resolve, reject){
            if (!self.mem){
                ...
                resolve.call(self, self.localMap);
                return;
            }
    ...
    getRepeatMap(){
        ...
        return new Promise(function(resolve, reject){
            if (!self.mem){
                ...
                resolve.call(self, self.localRepeat);
                return;
            }
    ...
    refresh(){
        ...
        if (this.mem) {
            ...
            this.localList = null;
            this.localMap = null;
            this.localRepeat = null;
        }
        this.load();
    }
});
module.exports = AbstractCacheManager;